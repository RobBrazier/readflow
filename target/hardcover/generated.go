...
// GetUserBooksBySlugAndEditionMeUsers includes the requested fields of the GraphQL type users.
// The GraphQL type's documentation follows.
//
// columns and relationships of "users"
type GetUserBooksBySlugAndEditionMeUsers struct {
	// An array relationship
	User_books []GetUserBooksBySlugAndEditionMeUsersUser_books `json:"user_books"`
}

// GetUser_books returns GetUserBooksBySlugAndEditionMeUsers.User_books, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsers) GetUser_books() []GetUserBooksBySlugAndEditionMeUsersUser_books {
	return v.User_books
}

// GetUserBooksBySlugAndEditionMeUsersUser_books includes the requested fields of the GraphQL type user_books.
// The GraphQL type's documentation follows.
//
// columns and relationships of "user_books"
type GetUserBooksBySlugAndEditionMeUsersUser_books struct {
	Status_id int `json:"status_id"`
	Book_id   int `json:"book_id"`
	// An object relationship
	Book GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks `json:"book"`
	// An object relationship
	Edition GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions `json:"edition"`
	// An array relationship
	User_book_reads []GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads `json:"user_book_reads"`
}

// GetStatus_id returns GetUserBooksBySlugAndEditionMeUsersUser_books.Status_id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_books) GetStatus_id() int { return v.Status_id }

// GetBook_id returns GetUserBooksBySlugAndEditionMeUsersUser_books.Book_id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_books) GetBook_id() int { return v.Book_id }

// GetBook returns GetUserBooksBySlugAndEditionMeUsersUser_books.Book, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_books) GetBook() GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks {
	return v.Book
}

// GetEdition returns GetUserBooksBySlugAndEditionMeUsersUser_books.Edition, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_books) GetEdition() GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions {
	return v.Edition
}

// GetUser_book_reads returns GetUserBooksBySlugAndEditionMeUsersUser_books.User_book_reads, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_books) GetUser_book_reads() []GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads {
	return v.User_book_reads
}

// GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks includes the requested fields of the GraphQL type books.
// The GraphQL type's documentation follows.
//
// columns and relationships of "books"
type GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks struct {
	Slug  string `json:"slug"`
	Title string `json:"title"`
}

// GetSlug returns GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks.Slug, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks) GetSlug() string { return v.Slug }

// GetTitle returns GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks.Title, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksBookBooks) GetTitle() string { return v.Title }

// GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions includes the requested fields of the GraphQL type editions.
// The GraphQL type's documentation follows.
//
// columns and relationships of "editions"
type GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions struct {
	Id    int `json:"id"`
	Pages int `json:"pages"`
}

// GetId returns GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions.Id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions) GetId() int { return v.Id }

// GetPages returns GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions.Pages, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksEditionEditions) GetPages() int { return v.Pages }

// GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads includes the requested fields of the GraphQL type user_book_reads.
// The GraphQL type's documentation follows.
//
// columns and relationships of "user_book_reads"
type GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads struct {
	Id             int       `json:"id"`
	...
	// An object relationship
	Edition GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions `json:"edition"`
}

// GetId returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetId() int { return v.Id }

// GetUser_book_id returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.User_book_id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetUser_book_id() int {
	return v.User_book_id
}

// GetProgress returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Progress, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetProgress() float32 {
	return v.Progress
}

// GetProgress_pages returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Progress_pages, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetProgress_pages() int {
	return v.Progress_pages
}

// GetStarted_at returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Started_at, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetStarted_at() time.Time {
	return v.Started_at
}

// GetFinished_at returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Finished_at, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetFinished_at() time.Time {
	return v.Finished_at
}

// GetEdition returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Edition, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) GetEdition() GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions {
	return v.Edition
}

func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) UnmarshalJSON(b []byte) error {
	...
	var firstPass struct {
		*GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads
		Started_at  json.RawMessage `json:"started_at"`
		Finished_at json.RawMessage `json:"finished_at"`
		graphql.NoUnmarshalJSON
	}
	firstPass.GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads = v
...

	{
		...
		if len(src) != 0 && string(src) != "null" {
			...
			if err != nil {
				return fmt.Errorf(
					"unable to unmarshal GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Started_at: %w", err)
			}
		}
	}

	{
		...
		if len(src) != 0 && string(src) != "null" {
			...
			if err != nil {
				return fmt.Errorf(
					"unable to unmarshal GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Finished_at: %w", err)
			}
		}
	}
	return nil
...
type __premarshalGetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads struct {
	Id int `json:"id"`
...
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) MarshalJSON() ([]byte, error) {
...
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads) __premarshalJSON() (*__premarshalGetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads, error) {
	var retval __premarshalGetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads

	retval.Id = v.Id
	retval.User_book_id = v.User_book_id
		...
		*dst, err = hardcover.MarshalHardcoverDate(
		...
		if err != nil {
			return nil, fmt.Errorf(
				"unable to marshal GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Started_at: %w", err)
		}
	}
	{
		...
		*dst, err = hardcover.MarshalHardcoverDate(
		...
		if err != nil {
			return nil, fmt.Errorf(
				"unable to marshal GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_reads.Finished_at: %w", err)
		}
	}
...
// GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions includes the requested fields of the GraphQL type editions.
// The GraphQL type's documentation follows.
//
// columns and relationships of "editions"
type GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions struct {
	Id    int `json:"id"`
	Pages int `json:"pages"`
}

// GetId returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions.Id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions) GetId() int {
	return v.Id
}

// GetPages returns GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions.Pages, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionMeUsersUser_booksUser_book_readsEditionEditions) GetPages() int {
	return v.Pages
}

// GetUserBooksBySlugAndEditionResponse is returned by GetUserBooksBySlugAndEdition on success.
type GetUserBooksBySlugAndEditionResponse struct {
	// execute function "me" which returns "users"
	Me []GetUserBooksBySlugAndEditionMeUsers `json:"me"`
}

// GetMe returns GetUserBooksBySlugAndEditionResponse.Me, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugAndEditionResponse) GetMe() []GetUserBooksBySlugAndEditionMeUsers {
	return v.Me
}
...
// GetUser_book_id returns GetUserBooksBySlugMeUsersUser_booksUser_book_reads.User_book_id, and is useful for accessing the field via an interface.
func (v *GetUserBooksBySlugMeUsersUser_booksUser_book_reads) GetUser_book_id() int {
	return v.User_book_id
}
...
// __GetUserBooksBySlugAndEditionInput is used internally by genqlient
type __GetUserBooksBySlugAndEditionInput struct {
	Slug      string `json:"slug"`
	EditionId int    `json:"editionId"`
}

// GetSlug returns __GetUserBooksBySlugAndEditionInput.Slug, and is useful for accessing the field via an interface.
func (v *__GetUserBooksBySlugAndEditionInput) GetSlug() string { return v.Slug }

// GetEditionId returns __GetUserBooksBySlugAndEditionInput.EditionId, and is useful for accessing the field via an interface.
func (v *__GetUserBooksBySlugAndEditionInput) GetEditionId() int { return v.EditionId }
...
// The query or mutation executed by GetUserBooksBySlugAndEdition.
const GetUserBooksBySlugAndEdition_Operation = `
...
func GetUserBooksBySlugAndEdition(
	ctx_ context.Context,
	client_ graphql.Client,
	slug string,
	editionId int,
) (*GetUserBooksBySlugAndEditionResponse, error) {
	req_ := &graphql.Request{
		OpName: "GetUserBooksBySlugAndEdition",
		Query:  GetUserBooksBySlugAndEdition_Operation,
		Variables: &__GetUserBooksBySlugAndEditionInput{
			Slug:      slug,
			EditionId: editionId,
		},
	}
	...
	var data_ GetUserBooksBySlugAndEditionResponse
	resp_ := &graphql.Response{Data: &data_}
