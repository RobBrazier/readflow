...
//go:embed queries/chapters_column.sql
var CHAPTERS_QUERY string

//go:embed queries/recent_reads.sql
var RECENT_READS_QUERY string
...
//go:embed queries/recent_reads_no_chapters.sql
var RECENT_READS_QUERY_NO_CHAPTERS string
...
//go:embed queries/previous_books_in_series.sql
var PREVIOUS_BOOKS_IN_SERIES_QUERY string

//go:embed queries/previous_books_in_series_no_chapters.sql
var PREVIOUS_BOOKS_IN_SERIES_QUERY_NO_CHAPTERS string
